<!-- Navbar -->
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl pt-3" id="navbarBlur"
    data-scroll="false">
        ...
        <div class="collapse navbar-collapse mt-sm-0 me-md-0 me-sm-4 justify-content-end" id="navbar">
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item dropdown d-flex align-items-center pe-1">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4" style="top: 0!important"
